...
const Sidebar = ({ isOpen, onClose }: { isOpen?: boolean; onClose?: () => void }) => {
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed md:relative top-0 left-0 z-50 h-dvh md:h-screen w-[80vw] sm:w-87.5 md:w-64 bg-white md:bg-[#f5f6f7] flex flex-col border-r border-slate-200 shrink-0 transition-transform duration-300 ease-in-out overflow-y-auto ${isOpen ? "translate-x-0" : "-translate-x-full md:translate-x-0"
          }`}
      >
        {/* Logo */}
